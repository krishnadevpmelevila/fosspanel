...
validate = [
  ...
  check('branch', 'Enter Branch')
    .isLength({ min: 2, max: 3 }),
  check('sem', 'Enter Semester')
...
router.post('/free-reg', validate, async (req, res) => {
  ...
  // block of code will run
    ...
    var activationCode = getRandomString(6);
      ...
      activation.save().then(result => {
        ...
        async function main() {
          ...
          let info = await transporter.sendMail({
            from: `Foss Intellects ${process.env.MAIL_FROM}`, // sender address
            to: req.body.email, // list of receivers
            subject: "Activation Code For Foss Intellects Registration", // Subject line
                                ...
                                <tbody>
                                    <tr>
                                        <td width="100%" align="center">
                                                                    ...
                                                                    <tr>
                                                                        <td width="100%" align="center">
                                                                            ...
                                                                            <h1
                                                                                ...
                                                                                Hi ${username}, Welcome to Foss Intellects!</h1>
                                                                        </td>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
                                            ...
                                            Foss Intellects &copy; 2022, All Rights Reserved</p>
                                            <!-- END CONTENT -->
                                ...
                                <tbody>
                                    <tr>
                                        <td width="100%" align="center">
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        <td width="100%" align="center">
                                                                            <p
                                                                                style="font-family:'Ubuntu', sans-serif; font-size:14px; color:#202020; padding-left:20px; padding-right:20px; text-align:justify;">
                                                                                We are glad to welcome you to Foss Intellects. All the best for your competetion. Good Luck!.</p>
                                                                            <p
                                                                                style="font-family:'Ubuntu', sans-serif; font-size:14px; color:#202020; padding-left:20px; padding-right:20px; text-align:justify;">
                                                                              <span><b style="color: red;">Your activation code is :</b> <strong style="color: green;">${activationCode}</strong></p></span> 
                                                                        </td>
                                            ...
                                            <p style="font-family:'Ubuntu Mono', monospace;  font-size:12px;">
                                            Foss Intellects &copy; 2021, All Rights Reserved</p>
                                            <!-- END CONTENT -->
